...
object SimpleNotificationUtil {

    private val NOTIFICATION_TAG = "SimpleUtil"
     ...
     * presentation of simple util notifications. Make
     * sure to follow the
     * [
 * Notification design guidelines](https://developer.android.com/design/patterns/notifications.html) when doing so.
    ...
    fun notify(context: Context,
        ...
        val title = res.getString(
                R.string.simple_util_notification_title_template, exampleString)
        val text = res.getString(
                R.string.simple_util_notification_placeholder_text_template, exampleString)
        ...
        val builder = NotificationCompat.Builder(context)
                ...
                .setSmallIcon(R.drawable.ic_stat_simple_util)
